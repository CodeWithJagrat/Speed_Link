...
const HomePage = ({route, navigation})=>{
  ...
  const {Heart_Rate} = route.params;
  const {Alcohol_Detector} = route.params;
  const {Oxygen_Level} = route.params;
        ...
        <ScrollView horizontal={true}>
          ...
          <View style={styles.box}>
            ...
            <View style={styles.innerbox2}>
              <Text style={styles.sectext}>Heart Rate:- {Heart_Rate}</Text>
              <Text></Text>
              <Text style={styles.sectext}>Alcohol Detector:- {Alcohol_Detector}</Text>
              <Text></Text>
              <Text style={styles.sectext}>Oxygen Level:- {Oxygen_Level}</Text>
            </View>
          </View>
        </ScrollView>
